...
async function main() {
  ...
  await prisma.resource.createMany({
    data: [
      ...
      // Quick Notes & Sticky Reminders (Headed cards for random & formal things)
      {
        title: "Saved Jokes for Friends",
        description: "1. Why do programmers prefer dark mode? Because light attracts bugs!\n2. There are 10 types of people in the world: those who understand binary, and those who don't.\n3. A SQL query walks into a bar, walks up to two tables and asks: 'Can I join you?'\n4. How many developers does it take to change a lightbulb? None, that's a hardware issue!",
        type: "note",
        category: "Humor & Friends",
        priority: "normal",
        tags: "Jokes,Friends,Fun",
        isPinned: true,
      },
      {
        title: "Links for Sports Shoes Online Shopping",
        description: "• Nike Air Zoom Pegasus 40 - Check upcoming festival discount on Myntra\n• Asics Gel-Kayano 30 (for marathon & long runs) - Added to Amazon wishlist\n• Puma Velocity Nitro 2 running shoes review: https://runrepeat.com\n• Coupon Code: SAVE20 (valid till month end)",
        type: "note",
        category: "Shopping & Wishlist",
        priority: "normal",
        tags: "Shopping,Shoes,Wishlist",
        isPinned: true,
      },
      {
      ...
      },
      {
        ...
        description: "1. Previous year grade card attested copy\n2. Income certificate renewal\n3. Bonafide student letter from Registrar office counter 4\n4. Submit before Friday 4:00 PM",
        type: "note",
        category: "Formal Admin",
        priority: "high",
        tags: "CollegeAdmin,Checklist,Urgent",
        isPinned: false,
      },
      {
        title: "Weekend Movie & Anime Recommendations",
        description: "• Oppenheimer (re-watch with roommates)\n• Jujutsu Kaisen Season 2 episodes\n• Silicon Valley Season 3 binge",
        type: "note",
        category: "Watchlist & Fun",
        priority: "low",
        tags: "Movies,Fun,Weekend",
        isPinned: false,
      },
    ],
  });
